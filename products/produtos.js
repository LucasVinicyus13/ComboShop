...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const produtos = [
    ...
    {
      imagem: "./images/Produto11.jpg",
      nome: "Chinelo Antiestresse",
      descricao: "Amortece até os boletos do fim do mês.",
      preco: 49.9,
      detalhes: "Feito com espuma viscoelástica que molda o seu desespero financeiro. Ideal para caminhadas até a geladeira e momentos de reflexão sobre a vida.",
    },
    {
      imagem: "./images/Produto12.jpeg",
      nome: "Camiseta 'Modo Avião'",
      descricao: "Pra quando você não quer falar com ninguém.",
      preco: 39.9,
      detalhes: "Tecido respirável que repele notificações sociais. Perfeita para dias de paz, maratonas de série e isolamento voluntário.",
    },
    {
      imagem: "./images/Produto13.jpg",
      nome: "Pente Inteligente 2.0",
      descricao: "Não desembaraça, mas te dá esperança.",
      preco: 25.0,
      detalhes: "Possui design ergonômico e poder moral. Ideal para quem já desistiu, mas ainda quer parecer arrumado.",
    },
    {
      imagem: "./images/Produto14.jpeg",
      nome: "Controle Remoto Universal de Namorado(a)",
      descricao: "Pause, mudo e sumiço instantâneo.",
      preco: 99.9,
      detalhes: "Compatível com todas as versões de relacionamento. Funções limitadas, mas altamente satisfatórias (não recarregável).",
    },
    {
      imagem: "./images/Produto15.png",
      nome: "Caneca 'Café, Sarcasmo e Caos'",
      descricao: "Combustível oficial de quem tá sobrevivendo.",
      preco: 29.9,
      detalhes: "Capacidade para 350ml de cafeína pura e ironia. Acompanha frases motivacionais que não ajudam em nada.",
    },
    {
      imagem: "./images/Produto16.png",
      nome: "Sabonete Motivacional",
      descricao: "Sai da cama, fedido!",
      preco: 14.9,
      detalhes: "Feito com essência de vergonha na cara e aroma de segunda-feira. Testado e aprovado por quem desistiu de tudo.",
    },
    {
      imagem: "./images/Produto17.png",
      nome: "Perfume 'Cheiro de Riqueza'",
      descricao: "Fragrância de quem ainda tá pagando o cartão.",
      preco: 59.9,
      detalhes: "Mistura notas de dólar imaginário com essência de sucesso não alcançado. Ideal para entrevistas e festas de família.",
    },
    {
      imagem: "./images/Produto18.jpeg",
      nome: "Luminária Antidarkness",
      descricao: "Garante 0% de escuridão (se ligada).",
      preco: 44.9,
      detalhes: "Ilumina ambientes e almas cansadas. Requer energia elétrica e força de vontade para funcionar.",
    },
    {
      imagem: "./images/Produto19.jpg",
      nome: "Mouse Pad de Luxo",
      descricao: "Feito com o mesmo material do tapete da vó.",
      preco: 44.9,
      detalhes: "Super macio, absorve suor e arrependimentos. Compatível com todos os mouses e mãos desmotivadas.",
    },
    {
      imagem: "./images/Produto20.jpg",
      nome: "Chaveiro GPS",
      descricao: "Nunca mais perca... até ele sumir também.",
      preco: 34.9,
      detalhes: "Emite um bip sonoro quando você o perde (se lembrar de ativar). Produto desaparece misteriosamente após uma semana.",
    },
    {
      imagem: "./images/Produto21.png",
      nome: "Caneta que Decide por Você",
      descricao: "Um lado 'Sim', outro 'Não'.",
      preco: 9.99,
    ...
    },
    {
      ...
      preco: 42.0,
      detalhes: "Boné com símbolo de Wi-Fi bordado. Não melhora a conexão, mas melhora o humor. E isso já é muita coisa.",
    },
    {
      imagem: "./images/Produto23.jfif",
      nome: "Relógio Sem Ponteiros",
      descricao: "Ideal para quem perdeu o tempo.",
      preco: 59.9,
      detalhes: "Design moderno e minimalista. Não mostra as horas, mas mostra seu estilo (e falta de pontualidade).",
    },
    {
      imagem: "./images/Produto24.jfif",
      nome: "Caixa de Som à Prova de Ex",
      descricao: "Só toca música boa.",
      preco: 89.9,
      detalhes: "Bloqueia automaticamente músicas tristes e reproduz apenas batidas de superação. Ideal para recomeçar com estilo.",
    },
    {
      imagem: "./images/Produto25.png",
      nome: "Meia com Wi-Fi Integrado",
      descricao: "Mentira, mas parece tecnológica.",
      preco: 19.9,
      detalhes: "Feita com fio de algodão premium e promessas falsas. Mantém seus pés quentinhos e suas expectativas frias.",
    },
    {
      imagem: "./images/Produto26.jpg",
      nome: "Espelho 'Autoestima +10'",
      descricao: "Te elogia até em dias ruins.",
      preco: 74.9,
      detalhes: "Toda vez que você olha, ele diz: 'Tá lindo(a) hoje!'. Produto pode gerar excesso de confiança e sorrisos espontâneos.",
    },
    {
      imagem: "./images/Produto27.png",
      nome: "Caneta Antiescola",
      descricao: "Para quem tem alergia a dever de casa.",
      preco: 7.9,
      detalhes: "Escreve automaticamente 'não quero fazer isso'. Recomendado por 10 de 10 alunos cansados.",
    },
    {
      imagem: "./images/Produto28.jpg",
      nome: "Capinha Blindada (Emocionalmente)",
      descricao: "Protege só o coração, não o celular.",
      preco: 32.9,
      detalhes: "Feita com borracha resiliente e boas intenções. Resiste a quedas leves e términos pesados.",
    },
    {
      imagem: "./images/Produto29.jpg",
      nome: "Pulseira da Paciência Infinita",
      descricao: "Acaba em 10 minutos.",
      preco: 18.9,
      detalhes: "Feita com elástico simbólico. Aumenta sua paciência até o primeiro problema do dia. Depois disso, boa sorte.",
    },
    {
      imagem: "./images/Produto30.jfif",
      nome: "Despertador Gritante",
      descricao: "Acorda até o vizinho da rua de trás.",
      preco: 69.9,
      detalhes: "Volume ajustável (de leve trauma até guerra mundial). Ideal para quem ignora 10 alarmes e ainda se atrasa.",
    },
  ]
